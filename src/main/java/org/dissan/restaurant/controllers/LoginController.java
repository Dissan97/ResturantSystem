...
public class LoginController {
    ...
    public void singUp() throws BadCommanEntryException, UserAlreadyExistException, ParseException, IOException {
        String username = this.userBean.getEntry(EnumCommand.USERNAME);
        String password = this.userBean.getEntry(EnumCommand.PASSWORD);
        ...
        String dateOfBirth = this.userBean.getEntry(EnumCommand.DATE_OF_BIRTH);
